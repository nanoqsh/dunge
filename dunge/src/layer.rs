use {
    crate::{
        ...
        storage::Storage,
        texture::Texture,
        vertex::{TextureVertex, VertexType},
    },
...
impl<'l, V> Layer<'l, V> {
    ...
    pub fn bind_instance(&mut self, InstanceHandle(id): InstanceHandle) -> Result<(), Error> {
    ...
    pub fn bind_view(&mut self, ViewHandle(id): ViewHandle) -> Result<(), Error> {
    ...
    pub fn draw(&mut self, MeshHandle(id): MeshHandle) -> Result<(), Error> {
